...
const FavoritesReducer = (state:State, action:FavoriteAction)=>{
    switch(action.type){
        case "ADD_MOVIE":
...
export const FavoriteContext = createContext<{ state: State, dispatch:React.Dispatch<FavoriteAction>;}>({state:INITIAL_STATE, dispatch:() =>{}});
