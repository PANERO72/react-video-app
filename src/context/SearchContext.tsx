...
const INITIAL_STATE: State = {
    sortBy: 'popularity.desc', genre: '', query: ''
};
...
export const SearchContext = createContext<{ state: State, dispatch:React.Dispatch<SearchAction>;}>({state:INITIAL_STATE, dispatch:() =>{}});
